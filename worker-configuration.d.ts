/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: afda1e3a5ff18433ed7884ddf0edcead)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_API_BASE">> {}
}
